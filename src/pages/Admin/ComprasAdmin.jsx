...
export const ComprasAdmin = () => {
  ...
  const filtrarBoletas = () => {
    return boletas.filter(b => {
      ...
      const fechaBoleta = b.fecha ? new Date(b.fecha).toISOString().split("T")[0] : "";
      const medioBoleta = b.medioPago ? b.medioPago.toLowerCase() : "";

      return (
        (!filtroCliente || nombreCompleto.includes(filtroCliente.toLowerCase())) &&
        (!filtroPago || medioBoleta === filtroPago.toLowerCase()) &&
  ...
  const listaFiltrada = filtrarBoletas();
          ...
          <div key={boleta.id_boleta} className="card mb-3 shadow-sm">
            <div className="card-body">
              ...
              <button
                ...
                onClick={() =>
                  (window.location.href = `/boleta/${boleta.id_boleta}`)
                }
              >
                Ver detalle
              </button>
